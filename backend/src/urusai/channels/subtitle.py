"""Dialogue channel populated from manual subtitle files (.srt / .vtt).

Fetches subtitles from a URL via yt-dlp and parses them with pysrt / webvtt.
Only manual subs are accepted — auto-generated captions are skipped because
they are another ASR provider's output, not authored text.
"""
...
class SubtitleChannel:
    """Dialogue channel populated from a manual subtitle file or URL (via yt-dlp)."""
